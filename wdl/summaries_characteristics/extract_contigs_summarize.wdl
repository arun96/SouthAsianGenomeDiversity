...
task ExtractContigsTask {
  ...
  command <<<
    ...
    awk -v n=1000 '/^>/{ if(l>n) print b; b=$0;l=0;next } {l+=length;b=b ORS $0}END{if(l>n) print b }' ~{assembly_fasta} > ~{sample_name}_contigs_1kb.fa
  ...
  output {
    ...
    File contigs_1kb_fasta = "~{sample_name}_contigs_1kb.fa" 
  }
}
...
# https://raw.githubusercontent.com/broadinstitute/gatk-sv-clinical/v0.7.1/wdl/Manta.wdl
# https://git.lumc.nl/biowdl/tasks/-/blob/master/manta.wdl?ref_type=heads
...
workflow Manta {
	input {
		...
		Float? jobs_per_cpu
		Int? mem_gb_per_job
		String manta_docker = "quay.io/biocontainers/manta:1.4.0--py27_1"
